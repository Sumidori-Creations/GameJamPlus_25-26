...
func _physics_process(delta: float) -> void:
	...
	var input_derecha: bool   = Input.is_action_pressed("movimiento derecho")
	var input_izquierda: bool = Input.is_action_pressed("movimiento izquierda")
	var input_abajo: bool     = Input.is_action_pressed("movimiento abajo")
	var input_arriba: bool    = Input.is_action_pressed("movimiento arriba")
